...
" Subsection: Tylers plugins
Plug 'Quramy/tsuquyomi'           "completions
...
augroup myfiletypes
  ...
  " autocmd FileType typescript set completeopt+=menu,preview shiftwidth=2 softtabstop=2 expandtab
  autocmd FileType typescript set shiftwidth=2 softtabstop=2 expandtab
  
  " was reading ts files as xml?
augroup END
...
let g:ale_linters = {
      ...
      \  'HTML': ['html-tidy'],
      \  'shell': ['shellcheck'],
      \  'typescript': ['type-check', 'tsserver'],
      \  'ruby': ['mri'],
      \  'eruby': ['erubylint']
      \}
